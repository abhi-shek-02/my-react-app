      ...
      <Container sx={{ mt: 1, mb: 10 }}>
        ...
        <Grid container spacing={4} alignItems="center" sx={{ mt: 5 }}>
          <Grid item xs={12} sm={6} order={{ xs: 2, sm: 1 }}>
            <Typography variant="body1" align="left" paragraph>
              At zingcab, we make intercity travel simple, affordable, and
              efficient. With our{" "}
              <Typography component="span" sx={{ fontWeight: "bold" }}>
                One Way Trip..One Way Payment
              </Typography>{" "}
              model, we connect travelers with cabs that would otherwise return
              empty—saving you money while ensuring a seamless travel
              experience. Whether for business or leisure, zingcab is your
              trusted partner for hassle-free journeys.
            </Typography>
          </Grid>
